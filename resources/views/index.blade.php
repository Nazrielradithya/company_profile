...
<head>
    ...
    <link rel="manifest" href="{{ asset('storage') }}/site.webmanifest">
                ...
                <div class="s-header__block">
                    <div class="s-header__logo">
                        <a class="logo" href="index.html">
                            <img src="{{ asset('storage') }}/images/logo.svg" alt="Homepage">
                        </a>
                    </div>
                    ...
                    <div class="column lg-12">
                        ...
                        <div
                            ...
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/snowflake.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/flash.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/rise.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/pinpoint.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/proline.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/vision.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/volume.svg" alt="">
                                </a>
                            </div>
                            <div class="column clients-list__item">
                                <a href="#0">
                                    <img src="{{ asset('storage') }}/images/clients/hitech.svg" alt="">
                                </a>
                            </div>
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="{{ asset('storage') }}/images/avatars/user-02.jpg"
                                            alt="Author image" class="s-testimonials__avatar">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="{{ asset('storage') }}/images/avatars/user-03.jpg"
                                            alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="{{ asset('storage') }}/images/avatars/user-01.jpg"
                                            alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
                                ...
                                <div class="s-testimonials__slide swiper-slide">
                                    <div class="s-testimonials__author">
                                        <img src="{{ asset('storage') }}/images/avatars/user-06.jpg"
                                            alt="Author image" class="s-testimonials__avatar">
                                        <cite class="s-testimonials__cite">
